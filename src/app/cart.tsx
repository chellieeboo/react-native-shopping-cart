    ...
    >
      ...
      {cart.length === 0 ? (
        <View style={styles.emptyContainer}>
          ...
          <Text style={[styles.empty, { color: colors.textDark }]}>
            Your shopping cart is empty.
          </Text>
          <Text style={[styles.emptySubtext, { color: colors.textSecondary }]}>
            Browse our instruments and add something to your cart.
          </Text>
          <TouchableOpacity
            style={[styles.continueShoppingBtn, { backgroundColor: colors.accent }]}
            onPress={() => router.push("/")}
          >
            <Text style={[styles.continueShoppingText, { color: colors.textDark }]}>
              Start Shopping
            </Text>
          </TouchableOpacity>
        </View>
